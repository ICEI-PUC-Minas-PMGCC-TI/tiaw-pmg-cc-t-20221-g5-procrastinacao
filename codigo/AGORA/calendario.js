...
function showEvents() {
   ...
   if (objWithDate) {
      ...
      emptyFormMessage.innerHTML = `${eventsCount} Tarefa para hoje.`;
   }

   if (eventsCount == 0) {
      let emptyMessage = document.createElement("div");
      emptyMessage.className = "empty-message";
      emptyMessage.innerHTML = "Nenhuma tarefa marcada para hoje.";
      sidebarEvents.appendChild(emptyMessage);
      let emptyFormMessage = document.getElementById("emptyFormTitle");
      emptyFormMessage.innerHTML = "Nenhuma tarefa.";
   }
}
